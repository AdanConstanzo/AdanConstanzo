...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _TerminalText__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TerminalText */ \"./src/scripts/TerminalText.js\");\n/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ \"./src/scripts/utils.js\");\n\n // Run this after DOM content loaded.\n\nwindow.addEventListener(\"DOMContentLoaded\", function () {\n  // constant variables being used.\n  var texts = [\"Web Apps\", \"Game Dev\", \"App Dev\", \"Automation\", \"Servers\", \"ReactJS\", \"NodeJS\", \"AI/ML/DL\", \"Tensor Flow\", \"Javascript\", \"CSS\"]; // html document references.\n\n  var scrollButton = document.getElementById('arrow');\n  var navbar = document.getElementById('nav');\n  var header = document.getElementById('home');\n  var headerHeight = header.clientHeight;\n  var terminalText = document.getElementById(\"terminal-text\").children[0]; // new terminal object.\n\n  var textText1 = new _TerminalText__WEBPACK_IMPORTED_MODULE_0__[\"default\"](texts, terminalText); // variable instance of listener so we can reference to remove later.\n\n  var aboutMeEvent = {\n    sectionId: 'about-me',\n    blocksClass: 'about-me-hidden'\n  };\n  aboutMeEvent.func = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[\"checkProjectScroll\"])(aboutMeEvent);\n  aboutMeEvent.cb = textText1.typeAnimation;\n  var projectScrollEvent = {\n    sectionId: 'projects',\n    blocksClass: 'projects-hidden'\n  };\n  projectScrollEvent.func = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[\"checkProjectScroll\"])(projectScrollEvent);\n  var blogsScrollEvent = {\n    sectionId: 'blogs',\n    blocksClass: 'blogs-hidden'\n  };\n  blogsScrollEvent.func = Object(_utils__WEBPACK_IMPORTED_MODULE_1__[\"checkProjectScroll\"])(blogsScrollEvent); // Initial check.\n\n  Object(_utils__WEBPACK_IMPORTED_MODULE_1__[\"checkProjectScroll\"])(aboutMeEvent)();\n  Object(_utils__WEBPACK_IMPORTED_MODULE_1__[\"checkProjectScroll\"])(projectScrollEvent)();\n  Object(_utils__WEBPACK_IMPORTED_MODULE_1__[\"checkProjectScroll\"])(blogsScrollEvent)(); // setting our scroll listeners\n\n  window.addEventListener('scroll', projectScrollEvent.func);\n  window.addEventListener('scroll', blogsScrollEvent.func);\n  window.addEventListener('scroll', aboutMeEvent.func);\n  window.addEventListener('scroll', Object(_utils__WEBPACK_IMPORTED_MODULE_1__[\"AddStickyNav\"])(navbar, headerHeight)); // Setting our click listeners.\n\n  scrollButton.addEventListener('click', Object(_utils__WEBPACK_IMPORTED_MODULE_1__[\"smoothScroll\"])(document.getElementById('about-me'))); // looping though our nav items. \n\n  for (var i = 0; i < navbar.children[0].children.length; i++) {\n    var li = navbar.children[0].children[i];\n    var attribute = li.getAttribute('data-ref');\n    li.addEventListener('click', Object(_utils__WEBPACK_IMPORTED_MODULE_1__[\"smoothScroll\"])(document.getElementById(attribute)));\n  }\n});\n\n//# sourceURL=webpack:///./src/scripts/main.js?");
