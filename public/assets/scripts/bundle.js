...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nvar openModal = function openModal(modal) {\n  return function () {\n    modal.classList.add('modal--open');\n    document.body.classList.add('no-scroll');\n  };\n};\n\nvar closeModal = function closeModal(e) {\n  var isOuterModal = e.target.classList.contains('modal');\n\n  if (isOuterModal) {\n    e.target.classList.remove('modal--open');\n  }\n\n  document.body.classList.remove('no-scroll');\n};\n\nvar init = function init() {\n  var projects = document.querySelectorAll('.projects-hidden-div');\n  projects.forEach(function (project) {\n    var projectId = project.getAttribute('data-modal');\n    var modal = document.getElementById(projectId);\n    project.addEventListener('click', openModal(modal));\n  });\n  var modals = document.querySelectorAll('.modal'); // setting event listeners for our close modals.\n\n  modals.forEach(function (modal) {\n    modal.addEventListener('click', closeModal);\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (init);\n\n//# sourceURL=webpack:///./src/scripts/modal.js?");
